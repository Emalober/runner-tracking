...
import com.ar.maloba.runnertracking.Constants.FASTEST_LOCATION_INTERVAL
import com.ar.maloba.runnertracking.Constants.LOCATION_UPDATE_INTERVAL
...
class TrackingService : LifecycleService() {
    ...
    private fun updateNotificationTrackingState(isTracking: Boolean) {
        ...
        if(!serviceKilled) {
            curNotificationBuilder = baseNotificationBuilder
                .addAction(R.drawable.ic_pause_24px, notificationActionText, pendingIntent)
